...
\end{equation}
Es lässt sich somit also auch wieder die Modenzahl $n$ bestimmen, da eine Berechnung von $L$ ohne $n$-Abhängigkeit möglich ist. Durch Umformung von Gleichung \ref{eqn:wtfisthis} nach $n$ 
ergibt sich
\begin{equation}
    \label{eqn:ayaya}
