...
%\begin{figure}
%    \centering
%    \includegraphics[width=0.9\textwidth]{bilder/buch.png}
%    \caption{Anschauliche Darstellung des möglichen Zerfalls eines Proton, welches anschließend in einem Myonen endet. \cite{Buch}} 
%    \label{fig:1}
%\end{figure}
=======
Es kommt, dass diese Protonen in der Atmosphäre unter anderem zu Pionen, bzw.$\pi$-Mesonen, zerfallen und diese wiederum zu Myonen. 
...
Der Zerfall eines einzelnen Myons ist ein statischer !!!!! %statisch = statistisch?
